        ...
        <div className="flex h-full w-full flex-col justify-center gap-8">
          ...
          <div className="flex flex-col justify-center gap-4 md:flex-row md:items-center md:justify-start">
            <Link href={detailsLink}>
              <Button
                className={
                  "w-full bg-black/20 text-white backdrop-blur-lg hover:bg-black/50 md:w-auto"
                }
              >
                Learn More
              </Button>
            ...
            <Link href={visitLink}>
              <Button
                className={
                  "w-full border border-white bg-gradient-to-bl from-from via-via to-to hover:bg-gradient-to-tr md:w-auto"
                }
              >
                Visit Site
              </Button>
